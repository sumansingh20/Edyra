...
router.use(authenticate, validateSession, authorize('admin', 'super-admin', 'institute-admin', 'organization-admin', 'campus-admin'), apiRateLimiter);
...
router.post('/semesters/:id/activate', semesterController.activateSemester);
router.post('/semesters/:id/archive', semesterController.archiveSemester);
...
router.post('/system/gpa/recalculate', adminController.runGPARecalculation);
router.post('/system/audit/run', adminController.runSecurityAudit);
router.post('/system/backup', adminController.initiateBackup);
router.get('/system/backups', adminController.getBackupList);
router.post('/system/sync', adminController.syncOrganizationData);
router.get('/reports/activity', adminController.getReportActivity);
...
// -- Courses --
router.get('/lms/courses', courseController.getCourses);
router.post('/lms/courses', courseController.createCourse);
router.get('/lms/courses/:id', courseController.getCourse);
router.put('/lms/courses/:id', courseController.updateCourse);
router.delete('/lms/courses/:id', courseController.deleteCourse);
router.post('/lms/courses/:id/enroll', courseController.enrollStudent);
router.delete('/lms/courses/:id/unenroll', courseController.unenrollStudent);
router.post('/lms/courses/:id/modules', courseController.addModule);
router.post('/lms/courses/:id/announcement', courseController.addCourseAnnouncement);

// Assignment management
router.get('/lms/assignments', assignmentController.getAssignments);
router.post('/lms/assignments', assignmentController.createAssignment);
router.get('/lms/assignments/:id', assignmentController.getAssignment);
router.put('/lms/assignments/:id', assignmentController.updateAssignment);
router.delete('/lms/assignments/:id', assignmentController.deleteAssignment);
router.get('/lms/assignments/:id/submissions', assignmentController.getSubmissions);
router.post('/lms/assignments/submissions/:submissionId/grade', assignmentController.gradeSubmission);

// Attendance management
router.get('/lms/attendance', attendanceController.getAttendance);
router.post('/lms/attendance', attendanceController.markAttendance);
router.post('/lms/attendance/qr', attendanceController.generateQR);
router.get('/lms/attendance/student/:studentId', attendanceController.getStudentAttendanceSummary);

// Gradebook
router.get('/lms/gradebook/:courseId', gradebookController.getCourseGradebook);
router.post('/lms/gradebook', gradebookController.upsertGrade);
router.post('/lms/gradebook/finalize', gradebookController.finalizeGrades);
router.post('/lms/gradebook/publish', gradebookController.publishGrades);
router.get('/lms/transcript/:studentId', gradebookController.getTranscript);

// Analytics
router.get('/lms/analytics/dashboard', analyticsController.getDashboardStats);
router.get('/lms/analytics/institution', analyticsController.getInstitutionAnalytics);
router.get('/lms/analytics/student/:studentId', analyticsController.getStudentAnalytics);
router.get('/lms/analytics/course/:courseId', analyticsController.getCourseAnalytics);
router.get('/lms/analytics/teacher/:teacherId', analyticsController.getTeacherAnalytics);

// Announcements
router.get('/lms/announcements', communicationController.getAnnouncements);
router.post('/lms/announcements', communicationController.createAnnouncement);
router.put('/lms/announcements/:id', communicationController.updateAnnouncement);
router.delete('/lms/announcements/:id', communicationController.deleteAnnouncement);

// Notifications
router.get('/lms/notifications', communicationController.getNotifications);

// Forum threads
router.get('/lms/forums', communicationController.getThreads);
router.post('/lms/forums', communicationController.createThread);
