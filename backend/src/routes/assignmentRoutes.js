...
import {
  ...
  submitAssignment, getSubmissions, gradeSubmission, requestResubmission, getSubmissionById
...
router.get('/submissions/:submissionId', authorize('admin', 'super-admin', 'institute-admin', 'teacher', 'teaching-assistant'), getSubmissionById);
