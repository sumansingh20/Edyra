...
export default function ForumThreadPage() {
  ...
  if (!thread) return <LMSLayout><div className="text-center py-12 text-gray-500">Thread not found</div></LMSLayout>;
  ...
  return (
    <LMSLayout breadcrumbs={[{ label: 'Edyra' }, { label: 'Communication', href: '/communication' }, { label: 'Thread' }]}>
