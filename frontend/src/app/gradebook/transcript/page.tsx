...
export default function TranscriptPage() {
  ...
  if (loading) return <LMSLayout><div className="text-center py-12 text-gray-500">Loading transcript...</div></LMSLayout>;
  if (!transcript) return <LMSLayout><div className="text-center py-12 text-gray-500">Transcript not available</div></LMSLayout>;

  const student = transcript.student || {};
  const semesters = transcript.semesters || [];

  return (
    <LMSLayout breadcrumbs={[{ label: 'Edyra' }, { label: 'Gradebook', href: '/gradebook' }, { label: 'Transcript' }]}>
