...
export default function CourseDetailPage() {
  ...
  if (!course) return <LMSLayout><div className="text-center py-12 text-gray-500">Course not found</div></LMSLayout>;

  return (
    <LMSLayout breadcrumbs={[{ label: 'Edyra' }, { label: 'Courses', href: '/courses' }, { label: course.code }]}>
