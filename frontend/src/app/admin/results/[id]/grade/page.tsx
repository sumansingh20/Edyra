...
export default function GradeSubmissionPage() {
  ...
  if (loading) return <LMSLayout><div className="p-8 text-center">Loading submission...</div></LMSLayout>;
  if (error) return <LMSLayout><div className="p-8 text-center text-red-600">{error}</div></LMSLayout>;
  if (!submission) return <LMSLayout><div className="p-8 text-center">Submission not found</div></LMSLayout>;
