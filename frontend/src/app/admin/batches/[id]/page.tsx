...
export default function BatchDetailPage() {
  ...
  if (loading) return <LMSLayout><div className="p-8 text-center">Loading batch...</div></LMSLayout>;
  if (error) return <LMSLayout><div className="p-8 text-center text-red-600">{error}</div></LMSLayout>;
  if (!batch) return <LMSLayout><div className="p-8 text-center">Batch not found</div></LMSLayout>;
