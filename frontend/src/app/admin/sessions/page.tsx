              ...
              <div className="lms-table-container">
                <table className="lms-table">
                  <tbody>
                    ...
                    <tr><td className="text-muted">Violations</td><td className={selectedSession?.violationCount >= (selectedSession?.maxViolationsAllowed || 0) - 1 ? 'text-red-600 font-bold' : ''}>{selectedSession?.violationCount || 0} / {selectedSession?.maxViolationsAllowed || 0}</td></tr>
                    <tr><td className="text-muted">IP Address</td><td className="font-mono">{selectedSession?.ipAddress || ''}</td></tr>
                    <tr><td className="text-muted">Auto-saves</td><td>{selectedSession?.autoSaveCount || 0}</td></tr>
                  </tbody>
                </table>
              </div>
