        ...
        <header style={{ backgroundColor: '#1d4f91', color: '#ffffff' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ fontWeight: 700, fontSize: '16px' }}>Edyra</span>
            </div>
          </div>
        </header>
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f8f9fa' }}>
      ...
      <header style={{ backgroundColor: '#1d4f91', color: '#ffffff' }}>
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none', color: '#ffffff' }}>
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: '16px', lineHeight: 1.2 }}>Edyra</div>
      ...
      <footer style={{
        ...
        <p style={{ margin: 0, fontSize: '12px', color: '#868e96' }}>
          &copy; 2026 Edyra &middot; Secure Online Examination System
        </p>
      </footer>
    </div>
  );
