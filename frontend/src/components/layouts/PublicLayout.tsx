        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-gray-900">Edyra</span>
            </Link>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-gray-100 border-t border-gray-300 mt-auto">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">Edyra</h3>
          ...
          <div className="mt-6 pt-4 border-t border-gray-300 text-xs text-gray-500 text-center">
                        © {new Date().getFullYear()} Edyra. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
